...
const BrandGrid = ({ eqType }) => {
    ...
    const brandList = {
        Lens: ['Angenieux', 'ARRI', 'Canon', 'Cooke', 'Fujinon', 'Sigma', 'Sony', 'Zeiss' ],
        Camera: ['ARRI', 'Blackmagic', 'Canon', 'Kinefinity', 'Panasonic', 'RED', 'Sony', 'Z-Cam' ],
        ...
        Media: ['CFast-2.0', 'CFExpress-Type-A', 'CFExpress-Type-B', 'SD', 'microSD', 'ARRI-Codex', 'Sony-XQD', 'Sony-SxS' ],
        Grip: ['Tripod', 'Stabilizer', 'Dolly', 'Crane', 'Car-Mount', 'Shoulder-Mount', 'Steadicam' ],
